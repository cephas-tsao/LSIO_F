<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="management_BDP070A_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
                <td class="style1">
                    角色編號<asp:Image ID="Image2" runat="server" ImageUrl="~/images/tick.png" /></td>
                <td class="style2">
                    <asp:TextBox ID="txt_grp_code" runat="server" MaxLength="4" Width="100px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style1">
                    角色名稱</td>
                <td class="style2">
                    <asp:TextBox ID="txt_grp_name" runat="server" MaxLength="50" Width="624px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style1">
                    是否使用</td>
