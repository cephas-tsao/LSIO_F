...
Partial Class basic_LSI021A_Default
    ...
    Protected Sub setGridViewData()
        ...
        End If
        '綁定事件
        AddHandler SqlDS1.Selecting, AddressOf SqlDS1_Selecting
    End Sub
    Protected Sub SqlDS1_Selecting(sender As Object, e As SqlDataSourceSelectingEventArgs)
        e.Command.CommandTimeout = 120  ' 單位秒
    End Sub
    '程式自定區 以上
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.Header Or e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(19).Visible = False '作業類別
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            txtSubWhere.Text = " WHERE 1=1 and roof_Source ='02'"
        End If
        'Response.Write(txtSubWhere.Text)
        'Response.End()
        setGridViewData()
