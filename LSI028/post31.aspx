...
'	  Dim dr2 As SQLDataReader = cmd2.ExecuteReader() 
    ...
    dim em = new System.Net.Mail.MailMessage()
     em.From = new System.Net.Mail.MailAddress("lio.epaper2@mail.taipei.gov.tw", "台北市勞動檢查處", System.Text.Encoding.UTF8)
     em.To.Add(new System.Net.Mail.MailAddress(""& Request("a3") &""))  '收件者
	  em.BCC.Add(new System.Net.Mail.MailAddress("")) 
     em.Subject = "自主輔導檢查通報回復內容"   '信件主題 
...
' dim em = new System.Net.Mail.MailMessage()
'     em.From = new System.Net.Mail.MailAddress("lio.epaper@mail.taipei.gov.tw", "台北市勞動檢查處", System.Text.Encoding.UTF8)
'     em.To.Add(new System.Net.Mail.MailAddress(""& Request("a3") &""))  '收件者
'	 em.BCC.Add(new System.Net.Mail.MailAddress("lio.epaper@mail.taipei.gov.tw"))    
'     em.Subject = "取消勞稽處安心電子報確認"   '信件主題 
'     em.SubjectEncoding = System.Text.Encoding.UTF8
'     em.Body = "<p>"& Request("a1") &"您好：</p><p>謝謝您訂閱台北市勞稽處平安電子報，如確定 <a href='https://172.25.157.135/epaper/post3.aspx?SN="& dr2.Item("chkSN") &"'>請點我取消訂閱</a>。</p><p>敬祝：平安健康</p><p>台北市勞稽處敬上</p><p>&nbsp;</p>" 
'     em.BodyEncoding = System.Text.Encoding.UTF8
'     em.IsBodyHtml = true	  '信件內容是否使用HTML格式
'     dim smtp = new System.Net.Mail.SmtpClient()
'     smtp.Port = 25
...
'     smtp.Send(em)
   ...
   response.Write ("<script>alert('回復內容已送出');window.location.href='Default-1-2.aspx?pc_code="& Request("pc_code") &"';</script>")
	response.end
