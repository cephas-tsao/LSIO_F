...
<input type="button" style="width: 100px; font-size: 14px; background-color:olivedrab; color: #fff;"  onclick="window.location.href='Default-1.aspx'" value="勞條科" /></td>
    ...
    <tr>
      ...
      <td height="44" align="center" <%if rowNo mod 2 = 0 then%>bgcolor="#9AEB65" <%else%> bgcolor="#D9F86B"<%end if%> >  <img src="document-download-outline.png" width="37" height="37"  onclick="window.open('https://service2.lio.gov.taipei/LSIO_F/Supload/Index?code=PC2112080001', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');"> </td>
...
<form name="form" method="post" action="post31.aspx" >
	...
	<input type="hidden" name="a3" id="a3" value="<%=DT.Rows(NowPageCount).Item("att_mail")%>"  placeholder="請電子郵件信箱">
      <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" >
        <tbody>
          <tr style="color: #fff;">
            <td height="30" align="center" bgcolor="#39A96B">回復內容</td>
          </tr>
          <tr style="color: #fff;">
