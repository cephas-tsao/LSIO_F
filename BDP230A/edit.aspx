<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="management_BDP230A_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
                <td class="style1">
                    部門編號<asp:Image ID="Image2" runat="server" ImageUrl="~/images/tick.png" /></td>
                <td class="style2">
                    <asp:TextBox ID="txt_dep_code" runat="server" MaxLength="10" Width="100px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style1">
                    部門名稱</td>
                <td class="style2">
                    <asp:TextBox ID="txt_dep_name" runat="server" MaxLength="30" Width="624px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style1">
                    部門層級</td>
                <td class="style2">
                    <asp:DropDownList ID="ddl_dep_level" runat="server">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td class="style1">
