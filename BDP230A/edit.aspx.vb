...
Partial Class management_BDP230A_edit
    Inherits PageBase
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '設定Key欄位來源
        Dim sKeyPrimary As String = txt_dep_code.Text '*修改處*
        ...
        If SaveEditData(s_prgcode, Pgm_Type, txt_dep_code.Text, txt_dep_name.Text, ddl_dep_level.SelectedValue, ddl_is_use.SelectedValue) Then
            '儲存使用紀錄
            ...
            If Pgm_Type <> "MDY" Then
                ...
                If txtSubWhere.Text <> "" Then
                    txtSubWhere.Text &= " OR dep_code='" & RepSql(sKeyPrimary) & "' "
                Else
                    txtSubWhere.Text = " WHERE dep_code='" & RepSql(sKeyPrimary) & "' "
                End If
            End If
            '存檔正確導回default頁面
    ...
    Protected Function Chk_data() As Boolean
        ...
        If txtPgmType.Text = "ADD" Then
            If Chk_RelData(s_prgcode, "", txt_dep_code.Text) = False Then
                Chk_data = False
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Set_DDL_Option("dep_level", "", ddl_dep_level, "", "", "")
                ...
                Case "MDY", "COPY"
                    ...
                    If Dt_tmp.Rows.Count > 0 Then
                        If Pgm_type = "COPY" Then
                            txt_dep_code.Text = ""
                            txt_dep_code.Enabled = True
                        Else
                            txt_dep_code.Text = txtPrimary.Text
                            txt_dep_code.Enabled = False
                        End If
                        txt_dep_name.Text = Trim(Dt_tmp.Rows(0).Item("dep_name") & "")
                        ddl_dep_level.SelectedValue = Trim(Dt_tmp.Rows(0).Item("dep_level") & "")
    ...
    Protected Sub SetClientCheck()
        '網頁伺服器端檢查點建置
        txt_dep_code.Attributes("onblur") = "javascript:IsEmpty(this);"
    End Sub
