<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addList.aspx.vb" Inherits="public_addList" %>
...
$("#TxtFind").autocomplete("AutoComplete.aspx?c=<%=Request("add_code") %>",
{
    delay: 10,
    width: 120,
        ...
        <table width="100%" border ="1">
            <tr style="background-color:#d3d3d3">
                <td style="width: 70%" colspan="2">
                    ...
                    <asp:CheckBox ID="CheckBox2" runat="server" Text="附加"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 70%">
                    ...
                    <asp:TextBox ID="txtChecked" runat="server" Visible="False"></asp:TextBox>
                    <asp:TextBox ID="txtChkName" runat="server" Visible="False"></asp:TextBox>
                    <asp:TextBox ID="txtColumn" runat="server" Visible="False"></asp:TextBox>
                <td style="width: 30%">
                    </td>
            </tr>
        </table>
