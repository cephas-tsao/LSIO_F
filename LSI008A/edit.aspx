...
<body>
    ...
    <div>
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
              <td class="style1">驗證碼</td>
              <td width="15%" class="style2">	<asp:Image ID="img_confirm" ImageUrl="confirm.ashx" runat="server" Height="44px"
                            Width="150px" /><br />
                <asp:Button ID="bn_new_confirm" runat="server" Text="重新產生驗證圖示" CssClass="text9pt"
                            OnClick="bn_new_confirm_Click" /></td>
              <td width="72%" class="style2">
