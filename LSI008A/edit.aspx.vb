...
Partial Class basic_LSI008A_edit
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
		...
		If Session("confirm") Is Nothing Then
			Show_Message("驗證碼無法確認!")
			 Return 
		ElseIf tb_confirm.Text.Trim() <> Session("confirm").ToString() Then
			Show_Message("驗證碼輸入錯誤!")
			 Return 
		End If
...
Dim OU4
Dim Y as Integer
Dim sqlstr2  = "select * From MEETING_ORDER where mrd_code='"& txt_mrd_code.text &"'"
...
Dim sqlstr1  = "select * From BDP080 where usr_code='"& dr2.Item("usr_code") &"'"
...
dim em = new System.Net.Mail.MailMessage()
     em.From = new System.Net.Mail.MailAddress("lio.epaper2@mail.taipei.gov.tw", "台北市勞動檢查處系統", System.Text.Encoding.UTF8)
     em.To.Add(new System.Net.Mail.MailAddress(""& dr1.Item("usr_mail") &""))  '收件者
	 'rem em.BCC.Add(new System.Net.Mail.MailAddress(""))  '收件者
