...
Partial Class basic_LSI012A_Default
    Inherits PageBase
...
Dim  pet_mail As New BoundField()
      ...
      Dim att_add2 As New BoundField()
      Dim att_tel2 As New BoundField()
      Dim att_name3 As New BoundField()
      Dim att_add3 As New BoundField()
      Dim att_tel3 As New BoundField()
      Dim pet_list As New BoundField()
      Dim pet_other As New BoundField()
 
      Dim ins_date As New BoundField()
'Dim eng_road As New BoundField()
Dim subname1 As New BoundField()
'Dim att_type As New BoundField()
'Dim sub_category2 As New BoundField()
...
eng_date_e.DataField="eng_date_e"
 eng_date_s.DataField="eng_date_s"

        '指定資料來源欄位
        sma_code.DataField = "sma_code"
        com_name.DataField = "com_name"
        eng_area.DataField = "eng_areas"
        eng_add.DataField = "eng_add"
        pet_date.DataField = "pet_date"
        usr_code.DataField = "usr_code"
pet_name.DataField = "usr_code"
pet_tel1.DataField = "pet_tel1"
pet_mail.DataField = "pet_mail" 
      att_name1.DataField = "att_name1"
      att_add1.DataField = "att_add1"
      att_tel1.DataField = "att_tel1"
      att_name2.DataField = "att_name2" 
      att_add2.DataField = "att_add2" 
      att_tel2.DataField = "att_tel2" 
      att_name3.DataField = "att_name3"
      att_add3.DataField = "att_add3" 
      att_tel3.DataField = "att_tel3"
      pet_list.DataField = "pet_list"
      pet_other.DataField = "pet_other"
      ins_date.DataField = "ins_date"
subname1.DataField = "subname1"


        '設定欄位標頭名稱
	eng_date_s.HeaderText="施工日期起"
        sma_code.HeaderText = "資料編號"
        com_name.HeaderText = "事業單位名稱"
        eng_area.HeaderText = "行業地點"
        eng_add.HeaderText = "工程地址"
        pet_date.HeaderText = "通報日期"
        usr_code.HeaderText = "建立者編號"
pet_name.HeaderText = "通報人姓名"
pet_tel1.HeaderText = "連絡電話"
pet_mail.HeaderText = "電子信箱"
      att_name1.HeaderText = "業主名稱"
      att_add1.HeaderText = "業主地址"
      att_tel1.HeaderText = "業主電話"
      att_name2.HeaderText = "施工廠商"
      att_add2.HeaderText = "施工廠商地址"
      att_tel2.HeaderText = "施工廠商電話"
      att_name3.HeaderText = "承攬人"
      att_add3.HeaderText = "承攬人地址"
      att_tel3.HeaderText = "承攬人電話"
      pet_list.HeaderText = "通報性質"
      pet_other.HeaderText = "其他說明"
      ins_date.HeaderText = "輸入日期"
subname1.HeaderText = "產業別"
eng_date_e.HeaderText = "施工日期訖"
        ...
        '設定排序所對應的欄位
        sma_code.SortExpression = "sma_code"
        com_name.SortExpression = "com_name"
        eng_area.SortExpression = "eng_areas"
        eng_add.SortExpression = "eng_add"
        pet_date.SortExpression = "pet_date"
        usr_code.SortExpression = "usr_code"

        '欄位寬度(%):要留6%給編輯圖示
        sma_code.ItemStyle.Width = Unit.Percentage(10)
        com_name.ItemStyle.Width = Unit.Percentage(10)
        eng_area.ItemStyle.Width = Unit.Percentage(10)
        eng_add.ItemStyle.Width = Unit.Percentage(20)
        pet_date.ItemStyle.Width = Unit.Percentage(10)
        att_tel1.ItemStyle.Width = Unit.Percentage(11)
        att_tel1.ItemStyle.Width = Unit.Percentage(11)

        '設定欄位標題顏色
        sma_code.HeaderStyle.CssClass = "grid1"
        com_name.HeaderStyle.CssClass = "grid1"
        eng_area.HeaderStyle.CssClass = "grid1"
        eng_add.HeaderStyle.CssClass = "grid1"
        pet_date.HeaderStyle.CssClass = "grid1"
        usr_code.HeaderStyle.CssClass = "grid1"

        '設定欄位的水平對齊
        sma_code.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        com_name.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        eng_area.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        eng_add.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        pet_date.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        usr_code.ItemStyle.HorizontalAlign = HorizontalAlign.Center

        '設定欄位是否顯示(不顯示的再設定)
        pet_name.Visible = False
	pet_tel1.Visible = False
	pet_mail.Visible = False
      att_name1.Visible = False
      att_add1.Visible = False
      att_tel1.Visible = False
      att_name2.Visible = False
      att_add2.Visible = False
      att_tel2.Visible = False
      att_name3.Visible = False
      att_add3.Visible = False
      att_tel3.Visible = False
      pet_list.Visible = False
      pet_other.Visible = False
      
      ins_date.Visible = False
      subname1.Visible = False
eng_date_s.Visible=True
eng_date_e.Visible=True



        GridView1.Columns.Add(sma_code) '1
        GridView1.Columns.Add(usr_code) '2
        GridView1.Columns.Add(com_name) '3
        GridView1.Columns.Add(eng_area)'4
        GridView1.Columns.Add(eng_add)'5
        GridView1.Columns.Add(pet_date)'6
GridView1.Columns.Add(pet_name)'7
GridView1.Columns.Add(pet_tel1)'8
GridView1.Columns.Add(pet_mail)'9
      GridView1.Columns.Add(att_name1)'10
      GridView1.Columns.Add(att_add1)'11
      GridView1.Columns.Add(att_tel1)'12
      GridView1.Columns.Add(att_name2)'13
      GridView1.Columns.Add(att_add2)'14
      GridView1.Columns.Add(att_tel2)'15
      GridView1.Columns.Add(att_name3)'16
      GridView1.Columns.Add(att_add3)'17
      GridView1.Columns.Add(att_tel3)'18
      GridView1.Columns.Add(pet_list)'19
      GridView1.Columns.Add(pet_other)'20
      GridView1.Columns.Add(ins_date)'21
	  GridView1.Columns.Add(eng_date_s)'23
	  GridView1.Columns.Add(eng_date_e)'23
GridView1.Columns.Add(subname1)'22
    ...
    Protected Sub setGridViewData()
        ...
        If txtSubWhere.Text <> "" Then
			...
			SqlDS1.SelectCommand = "SELECT Small_space.*,C.subname1 as subname1,BDP210.field_name as eng_areas  FROM Small_space" & _
                               " LEFT JOIN BDP210 ON Small_space.eng_area=BDP210.field_code AND BDP210.code_code='ZipCode'   LEFT JOIN V_IND_NAME C on Small_space.sub_category=C.code" & txtSubWhere.Text & txtOrder.Text
			
        Else
            'SqlDS1.SelectCommand = Get_SqlStr(s_prgcode, "SELECT", "WHERE 1=0")
			SqlDS1.SelectCommand = "SELECT Small_space.*,C.subname1 as subname1,BDP210.field_name as eng_areas  FROM Small_space" & _
                               " LEFT JOIN BDP210 ON Small_space.eng_area=BDP210.field_code AND BDP210.code_code='ZipCode'   LEFT JOIN V_IND_NAME C on Small_space.sub_category=C.code  order by   sma_code desc" 
        End If
...
Protected Sub bt_excelALL_Click(ByVal sender As Object ,ByVal e As System.EventArgs) Handles bt_excelALL.Click
        bPrint = True '開始輸出Excel




For AI As Integer = 1 To CBL_Field1.Items.Count -1
                  If CBL_Field1.Items(AI).Selected = True Then
                       GridView1.Columns(AI+2).Visible = True
		    ELSE
			GridView1.Columns(AI+2).Visible = false
                  End If
 Next

  If CBL_Field1.Items(0).Selected = True Then
