<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="basic_LSI012A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
...
function Chk_All_1() {
	...
	//alert('TEST');
	if (document.getElementById("CBL_Field1_1").checked===true) {
document.getElementById("CBL_Field1_0").checked=false;
...
document.getElementById("CBL_Field1_24").checked=false;

}else{
	document.getElementById("CBL_Field1_0").checked=true;
...
document.getElementById("CBL_Field1_24").checked=true;
}
}
    ...
    <form id="form1" runat="server">
     ...
     <tr>
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left" Visible="False">
            ...
            <td class="export02" style="width: 5%;"><asp:Button ID="bt_excelALL" runat="server" Text="匯出Excel" PostBackUrl="Default.aspx" />
				<!--<input type="button"  onclick="window.location.href='EX20220102585562.xlsx'" value="匯出全部欄位" />-->
            </td></tr></table>
        </asp:Panel>       
