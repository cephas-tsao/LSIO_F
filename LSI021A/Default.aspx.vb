...
Partial Class basic_LSI021A_Default
    ...
    Protected Sub setFields()
        ...
        Dim roof_tool1_c As New BoundField()
        Dim roof_sdate As New BoundField()
        Dim roof_edate As New BoundField()
        Dim tear_tool1_c As New BoundField()
        Dim tearon_sdate As New BoundField()
        Dim tearon_edate As New BoundField()
        Dim tearoff_sdate As New BoundField()
        Dim tearoff_edate As New BoundField()
        ...
        roof_tool1_c.DataField = "roof_tool1_c"
        roof_sdate.DataField = "roof_sdate"
        roof_edate.DataField = "roof_edate"
        tear_tool1_c.DataField = "tear_tool1_c"
        tearon_sdate.DataField = "tearon_sdate"
        tearon_edate.DataField = "tearon_edate"
        tearoff_sdate.DataField = "tearoff_sdate"
        tearoff_edate.DataField = "tearoff_edate"
        ...
        att_tel2.HeaderText = "行動電話"
        roof_mail.HeaderText = "聯絡人Email"
        pet_date.HeaderText = "通報日期"
        roof_tool1_c.HeaderText = "輕質屋頂作業"
        roof_sdate.HeaderText = "預定施工時間起"
        roof_edate.HeaderText = "預定施工時間迄"
        'tear_tool1_c.HeaderText = "施工架組配與拆除"
        'tearon_sdate.HeaderText = "預定組配時間起"
        'tearon_edate.HeaderText = "預定組配時間迄"
        'tearoff_sdate.HeaderText = "預定拆除時間起"
        'tearoff_edate.HeaderText = "預定拆除時間迄"
        ...
        roof_tool1_c.SortExpression = "roof_tool1_c"
        roof_sdate.SortExpression = "roof_sdate"
        roof_edate.SortExpression = "roof_edate"
        'tear_tool1_c.SortExpression = "tear_tool1_c"
        'tearon_sdate.SortExpression = "tearon_sdate"
        'tearon_edate.SortExpression = "tearon_edate"
        'tearoff_sdate.SortExpression = "tearoff_sdate"
        'tearoff_edate.SortExpression = "tearoff_edate"
        ...
        att_tel1.ItemStyle.Width = Unit.Percentage(12)
        ...
        roof_tool1_c.ItemStyle.Width = Unit.Percentage(10)
        roof_sdate.ItemStyle.Width = Unit.Percentage(10)
        roof_edate.ItemStyle.Width = Unit.Percentage(10)
        'tear_tool1_c.ItemStyle.Width = Unit.Percentage(10)
        'tearon_sdate.ItemStyle.Width = Unit.Percentage(10)
        'tearon_edate.ItemStyle.Width = Unit.Percentage(10)
        'tearoff_sdate.ItemStyle.Width = Unit.Percentage(10)
        'tearoff_edate.ItemStyle.Width = Unit.Percentage(10)
        ...
        roof_tool1_c.HeaderStyle.CssClass = "grid1"
        roof_sdate.HeaderStyle.CssClass = "grid1"
        roof_edate.HeaderStyle.CssClass = "grid1"
        'tear_tool1_c.HeaderStyle.CssClass = "grid1"
        'tearon_sdate.HeaderStyle.CssClass = "grid1"
        'tearon_edate.HeaderStyle.CssClass = "grid1"
        'tearoff_sdate.HeaderStyle.CssClass = "grid1"
        'tearoff_edate.HeaderStyle.CssClass = "grid1"
        ...
        roof_tool1_c.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        roof_sdate.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        roof_edate.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        'tear_tool1_c.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        'tearon_sdate.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        'tearon_edate.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        'tearoff_sdate.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        'tearoff_edate.ItemStyle.HorizontalAlign = HorizontalAlign.Left
        ...
        GridView1.Columns.Add(roof_tool1_c)
        GridView1.Columns.Add(roof_sdate)
        GridView1.Columns.Add(roof_edate)
        'GridView1.Columns.Add(tear_tool1_c)
        'GridView1.Columns.Add(tearon_sdate)
        'GridView1.Columns.Add(tearon_edate)
        'GridView1.Columns.Add(tearoff_sdate)
        'GridView1.Columns.Add(tearoff_edate)
        ...
        'GridView1.Columns.Add(roof_path1)
        'GridView1.Columns.Add(roof_path2)
    ...
    Protected Sub setGridViewData()
        ...
        Else
            ...
            SqlDS1.SelectCommand = Get_SqlStr(s_prgcode, "SELECT", " WHERE roof_cod LIKE 'rf18%' and roof_Source ='01'")
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.Header Or e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(13).Visible = True '輕質屋頂作業
            e.Row.Cells(14).Visible = False
            e.Row.Cells(15).Visible = False
            e.Row.Cells(16).Visible = True '作業類別
        ...
        Select Case e.Row.RowType
            ...
            Case DataControlRowType.DataRow
                ...
                System.Diagnostics.Debug.WriteLine("Cells.Count: " & e.Row.Cells.Count)
                ...
                For i As Integer = 0 To ckl_rtype2.Items.Count - 1
                    ...
                    If (e.Row.Cells(16).Text <> "") Then
                        ...
                        If (e.Row.Cells(16).Text = "1") Then
                            e.Row.Cells(16).Text = Mid(ckl_rtype2.Items(0).Text, 3, 2)
                        End If


                        If (e.Row.Cells(16).Text = "2") Then
                            e.Row.Cells(16).Text = Mid(ckl_rtype2.Items(1).Text, 3, 3)

                        End If

                        If (e.Row.Cells(16).Text = "3") Then
                            e.Row.Cells(16).Text = Mid(ckl_rtype2.Items(2).Text, 3, 5)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            txtSubWhere.Text = " WHERE 1=1 and roof_Source =1 "
        End If
        'Response.Write(txtSubWhere.Text)
        'Response.End()
        setGridViewData()
