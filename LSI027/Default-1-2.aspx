 ...
 Dim pic2,seq1,seq2,seq3,seq4,seq5,seq6,seq7,seq8,seqtt
  ...
  Dim IDA As String = Request("ID") 
   ...
   Dim SqlStra1 As String
       ...
       SqlStra1  = "SELECT * FROM LSI025 where pc_code='"& Request("pc_code") &"' order by pc_code desc"
...
<body>
      ...
      <table width="100%" border="0">
        <tbody>
          <tr>
		    ...
		    <td width="37%" align="center"><input type="button" style="width: 100px; font-size: 14px;"  onclick="window.location.href='Default.aspx'" value="回上一頁" />&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <tr style="color: #fff;">
      ...
      <td height="30" align="center" bgcolor="#39A96B">填報檔案</td>
      <td align="center" bgcolor="#39A96B">填報編號</td>
      <td align="center" bgcolor="#39A96B">填報日期</td>
	 
	  <td align="center" bgcolor="#39A96B">填報單位</td>
      <td align="center" bgcolor="#39A96B">填報單位聯繫資訊</td>
    ...
    <tr>
      ...
      <td height="44" align="center" <%if rowNo mod 2 = 0 then%>bgcolor="#9AEB65" <%else%> bgcolor="#D9F86B"<%end if%> >  <img src="document-download-outline.png" width="37" height="37"  onclick="window.open('https://service2.lio.gov.taipei/LSIO_F/upload/File_Tower/<%=DT.Rows(NowPageCount).Item("pc_code")%>/<%=DT.Rows(NowPageCount).Item("pc_code")%>.jpg', '_blank', 'location=yes,height=570,width=520,scrollbars=yes,status=yes');"> </td>
...
<form name="form" method="post" action="post31.aspx" >
	...
	<input type="hidden" name="a3" id="a3" value="<%=DT.Rows(NowPageCount).Item("att_mail")%>"  placeholder="請電子郵件信箱">
      <table width="95%"  border="0" align="center" cellpadding="1" cellspacing="1" >
        <tbody>
          <tr style="color: #fff;">
            <td height="30" colspan="2" align="center" bgcolor="#39A96B">通報內容</td>
          </tr>
          <tr >
            <td width="21%" style="color: #fff;" height="21" align="center" valign="top" bgcolor="#39A96B">主旨</td>
            <td width="79%" align="center" valign="top" bgcolor="#39A96B">
				<input type="text" style="width: 100%;" name="stitle" id="stitle" value=""> </td>
          </tr>
          <tr style="color: #fff;">
            <td height="106" colspan="2" align="center" valign="top" bgcolor="#FFFFFF">
            <textarea style="width: 100%" name="textarea" id="textarea" cols="45" rows="5"></textarea></td>
          </tr>
          <tr style="color: #fff;">
            <td height="23" colspan="2" align="center" bgcolor="#FFFFFF"><button type="submit" class="btn btn-primary" style="font-size:13pt; padding:0px; width:100px; background-color:darkgreen; color: aliceblue;"  >立即發送</button></td>
          </tr>
