 ...
 Dim pic2,seq1,seq2,seq3,seq4,seq5,seq6,seq7,seq8,seqtt
  ...
  Dim IDA As String = Request("ID") 
   ...
   Dim SqlStra1 As String
       ...
       SqlStra1  = "SELECT * FROM LSI025  order by pc_code desc"
...
<input type="button"  onclick="xls()" value="匯出Excel" /></td>
  ...
  <table width="100%" border="0">
    ...
    <tr style="color: #fff;">
      ...
      <td height="30" align="center" bgcolor="#39A96B">檢點表</td>
      <td align="center" bgcolor="#39A96B">填報編號</td>
      <td align="center" bgcolor="#39A96B">填報日期</td>
	 
	  <td align="center" bgcolor="#39A96B">填表單位</td>
      <td align="center" bgcolor="#39A96B">填表單位聯繫資訊</td>
