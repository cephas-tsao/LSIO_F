        ...
        For i As Integer = 0 To ckl_pc_kind1.Items.Count - 1
            If ckl_pc_kind1.Items(i).Selected = True Then
                ...
                Else
                    txtSubWhere.Text &= " OR "
                End If
                txtSubWhere.Text &= "LSI025.pc_kind1" & " LIKE N'%" & RepSql(ckl_pc_kind1.Items(i).Value) & "%'"
            End If
        Next
		...
		For i As Integer = 0 To ckl_pc_kind2.Items.Count - 1
            If ckl_pc_kind2.Items(i).Selected = True Then
                ...
                Else
                    txtSubWhere.Text &= " OR "
                End If
                txtSubWhere.Text &= "LSI025.pc_kind2" & " LIKE N'%" & RepSql(ckl_pc_kind2.Items(i).Value) & "%'"
            End If
        Next
