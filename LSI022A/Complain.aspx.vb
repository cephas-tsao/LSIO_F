...
Partial Class basic_LSI002A_YComplain
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If SaveEditData(s_prgcode, "Complain", txt_content.Text) Then


            '儲存使用紀錄
            ws.InsUsrRec(PrgMemo, "Complain", s_prgcode, Session("usr_code"), Session("usr_ip"), sFieldName, sOldData, sNewData)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim Dt_tmp As DataTable = Get_DataSet("Complain", "").Tables(0)
