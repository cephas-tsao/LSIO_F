...
Partial Class management_BDP007A_Default
    Inherits PageBase

    Dim ws As New WebReference.LSIO_WebService
    Dim s_prgcode As String = "BDP007A"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Set_DDL_Option("css_sys", "", DropDownList1, "", " ", "")
            DropDownList1.SelectedValue = ws.Get_SysPara("css_sys", "01")
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If SaveEditData(s_prgcode, "MDY", DropDownList1.SelectedValue) Then
