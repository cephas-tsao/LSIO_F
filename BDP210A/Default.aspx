<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="management_BDP210A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
...
<body >
    <form id="form1" runat="server">
     ...
     <tr>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton4" runat="server" CausesValidation="false" CommandArgument="COPY"
                                        ...
                                        Text="按鈕" ToolTip="複製" Visible="True" />
                                </ItemTemplate>
                                <HeaderStyle CssClass="grid1" />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
        ...
        <asp:TextBox ID="textIsuse" runat="server" Visible="False" />
