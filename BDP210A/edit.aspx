<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="management_BDP210A_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            <tr>
                <td class="fail" colspan="4" style="text-align: center">
            ...
            <tr>
                ...
                <td class="style2" width="23%">
                    <asp:TextBox ID="txt_code_code" runat="server" MaxLength="10"></asp:TextBox>
                                </td>
                <td class="style1" width="10%">
                    代碼名稱</td>
                <td class="style2" width="23%">
                    <asp:TextBox ID="txt_code_name" runat="server" MaxLength="30"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style1" style="width: 13%">
                                        選項中文</td>
                <td class="style2" width="23%">
                    <asp:TextBox ID="txt_field_name" runat="server" MaxLength="50"></asp:TextBox>
                </td>
                <td class="style1" width="10%">
                    選項值</td>
                <td class="style2" width="23%">
            ...
            <tr>
                <td class="style1">顯示順序</td>
                <td class="style2">
                    <asp:TextBox ID="txt_scr_no" runat="server" MaxLength="4"></asp:TextBox>
                </td>
                <td class="style1">類別</td>
                <td class="style2">
                    <asp:DropDownList ID="ddl_code_type" runat="server">
                        <asp:ListItem Selected="True" Value="S">S.系統用</asp:ListItem>
                        <asp:ListItem Value="B">B.客制用</asp:ListItem>
                    </asp:DropDownList>
                </td>
                
            </tr>
            <tr>                
                <td class="style1">是否使用</td>
                <td class="style2">
                    <asp:DropDownList ID="ddl_isuse" runat="server">                  
