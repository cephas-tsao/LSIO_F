...
Partial Class basic_LSI024A_edit
    Inherits PageBase

    Dim ws As New WebReference.LSIO_WebService
    Dim s_prgcode As String = "LSI024A"
    ...
    Protected Sub Bt_send_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Bt_send.Click
        ...
        Dim sBody As String = "" & _
                ...
                "<tr bgcolor='#7EBAD1' align='center'><td colspan='20'><p><strong>精準檢查作業通報</strong></p></td></tr>" & _
        ...
        If SendMail("臺北市勞動檢查處-申辦服務-精準檢查作業通報-送出成功", dtMail, sBody, s_prgcode) Then
            Show_Message("送出成功")
        Else
