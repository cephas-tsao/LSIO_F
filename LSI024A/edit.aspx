<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="basic_LSI024A_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>
        <table cellpadding=5 cellspacing=0 width="100%" border="1" id="customers">
            ...
            <tr align="center"><td colspan="20" class="style1">精準檢查作業</td></tr>
