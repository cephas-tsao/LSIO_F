<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="basic_LSI024A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
...
function Chk_All_1() {
 for (var i = 1; i <= 17; i++) {
document.getElementById("CBL_Field1_"+i).checked=true;
        ...
        <tr><td class="fail" colspan="2" style="text-align: center"><font color="blue">請輸入查詢條件：</font></td></tr>
             ...
             <tr>
                ...
                <td class="style2">
                    ...
                    <asp:ImageButton ID="img_date5" runat="server" 
                        ImageUrl="~/images/calendr.gif" />
                     <font color="red">~<asp:TextBox ID="txt_epc_date_e" runat="server" 
            ...
            <tr>
                <td class="style1">
                    丁類危險性工作場所主要危害作業</td>
                <td class="style2">
                    <asp:CheckBoxList ID="ckl_pc_kind1" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
                        Height="16px">
                    </asp:CheckBoxList></td>
            </tr>
			...
			<tr>
                <td class="style1">
                    機械作業</td>
                <td class="style2">
                    <asp:CheckBoxList ID="ckl_pc_kind2" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
                        Height="16px">
                    </asp:CheckBoxList></td>
            </tr>
