<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="basic_LSI017A_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
    ...
    <div>
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
                ...
                <td class="style2">
                    <asp:TextBox ID="txt_app_code" runat="server" MaxLength="12" Width="120px" 
                        Enabled="False"></asp:TextBox>
                    <font color="red">系統自動取號</font></td>
            </tr>
            <tr>
                <td class="style1">
                    版本號碼<asp:Image ID="Image1" runat="server" ImageUrl="~/images/tick.png" /></td>
                <td class="style2">
                    <asp:TextBox ID="txt_verison" runat="server" MaxLength="10" Width="500px"></asp:TextBox>
                                </td>
            </tr>
            <tr>
                <td class="style1">
                    檔案名稱<asp:Image ID="Image3" runat="server" ImageUrl="~/images/tick.png" /></td>
                <td class="style2">
                    <asp:FileUpload ID="FileUpload1" runat="server" />
                    <asp:Label ID="lab_app_path" runat="server" Text="附檔1"></asp:Label>
                                </td>
            </tr>
            <tr>
                <td class="style1">
                    APP種類<asp:Image ID="Image4" runat="server" ImageUrl="~/images/tick.png" /></td>
                <td class="style2">
                    <asp:DropDownList ID="ddl_app_type" runat="server">
                    </asp:DropDownList>
                    </td>
            </tr>
            <tr>
                <td class="style1">
                    安裝資訊</td>
                <td class="style2">
                    <asp:TextBox ID="txt_cmemo" runat="server" MaxLength="100" Width="500px"></asp:TextBox>
                                </td>
            </tr>
            <tr>
                <td class="style1">
                    更新日期</td>
                <td class="style2">
                    <asp:TextBox ID="txt_update_date" runat="server" MaxLength="10" Width="100px" 
            ...
            <asp:TextBox ID="txt_version_name" runat="server" Visible="False" />
            <br />
