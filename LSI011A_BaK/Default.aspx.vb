...
Partial Class basic_LSI011A_Default
    Inherits PageBase
    ...
    Protected Sub setFields()
        ...
        self_date.SortExpression = "self_date"

        '欄位寬度(%):要留6%給編輯圖示
        self_code.ItemStyle.Width = Unit.Percentage(15)
        usr_code.ItemStyle.Width = Unit.Percentage(10)
        com_name.ItemStyle.Width = Unit.Percentage(20)
        eng_name.ItemStyle.Width = Unit.Percentage(20)
        eng_add.ItemStyle.Width = Unit.Percentage(20)
        self_date.ItemStyle.Width = Unit.Percentage(15)

        '設定欄位標題顏色
        self_code.HeaderStyle.CssClass = "grid1"
        ...
        self_date.HeaderStyle.CssClass = "grid1"

        '設定欄位的水平對齊
        self_code.ItemStyle.HorizontalAlign = HorizontalAlign.Center
