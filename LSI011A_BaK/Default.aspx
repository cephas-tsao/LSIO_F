<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="basic_LSI011A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
...
<asp:TextBox ID="date_find" runat="server" CssClass="findtb" type="date" value="dd. MM yyyy">開始日期</asp:TextBox>
<asp:TextBox ID="date_find2" runat="server" CssClass="findtb" type="date" value="dd. MM. yyyy">結束日期</asp:TextBox>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                            <asp:TemplateField ShowHeader="False">
                                ...
                                <!--    <asp:ImageButton CssClass="searchBtn"  ID="ImageButton2" runat="server" CausesValidation="false" CommandName="delete"
                                        ImageUrl="<i class='far fa-trash-alt'></i>" OnClientClick="return confirm('確定要刪除資料?');"
                                        Text="按鈕" ToolTip="刪除" PostBackUrl="Default.aspx" /> -->
                              
              <button  runat="server"  OnClientClick="return confirm('確定要刪除資料?');" ID="ImageButtonp2"><i class="far fa-trash-alt"></i> </button>
  </ItemTemplate>
