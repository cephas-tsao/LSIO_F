    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
	    ...
	    Set_CKL_Option("rtype2", "",chk_rtype2, "", "", "")
			...
			Set_CKL_Click(Trim(Dt_tmp.Rows(0).Item("rtype2") & ""), chk_rtype2, "rtype2")
                        ...
                        Dim sTmpArr3 = Split(Trim(Dt_tmp.Rows(0).Item("licen_man") & ""), ",")
                        Dim sTmpArr4 = Split(Trim(Dt_tmp.Rows(0).Item("licen_cage") & ""), ",")
                        Dim sTmpArr5 = Split(Trim(Dt_tmp.Rows(0).Item("licen_other") & ""), ",")
...
IMG17.Visible="False"
                        ...
                        If Not IsDBNull(Dt_tmp.Rows(0).Item("roof_path1")) AndAlso Dt_tmp.Rows(0).Item("roof_path1").ToString() <> "" Then
                        ...
                        If Not IsDBNull(Dt_tmp.Rows(0).Item("licen_man")) AndAlso Dt_tmp.Rows(0).Item("licen_man").ToString() <> "" Then
                            s_Image_Navigate_Url = sPath & HttpUtility.HtmlEncode(sTmpArr3(0))

                            IMG15.ImageUrl = s_Image_Navigate_Url
                            HyperLink15.NavigateUrl = s_Image_Navigate_Url
                            IMG15.Visible = "True"
                        End If

                        If Not IsDBNull(Dt_tmp.Rows(0).Item("licen_cage")) AndAlso Dt_tmp.Rows(0).Item("licen_cage").ToString() <> "" Then
                            s_Image_Navigate_Url = sPath & HttpUtility.HtmlEncode(sTmpArr4(0))

                            IMG16.ImageUrl = s_Image_Navigate_Url
                            HyperLink16.NavigateUrl = s_Image_Navigate_Url
                            IMG16.Visible = "True"
                        End If


                        If Not IsDBNull(Dt_tmp.Rows(0).Item("licen_other")) AndAlso Dt_tmp.Rows(0).Item("licen_other").ToString() <> "" Then
                            s_Image_Navigate_Url = sPath & HttpUtility.HtmlEncode(sTmpArr5(0))

                            IMG17.ImageUrl = s_Image_Navigate_Url
                            HyperLink17.NavigateUrl = s_Image_Navigate_Url
                            IMG17.Visible = "True"
                        End If
                        REM 2024.02.25 修改路徑參數為指定 s_Image_Navigate_Url		

                        If Not IsDBNull(Dt_tmp.Rows(0).Item("roof_path2")) AndAlso Dt_tmp.Rows(0).Item("roof_path2").ToString() <> "" Then
