...
rtype2.SortExpression = "rtype2"
        ...
        com_name.ItemStyle.Width = Unit.Percentage(15)
        ...
        att_tel1.ItemStyle.Width = Unit.Percentage(8)
        att_name2.ItemStyle.Width = Unit.Percentage(5)
            ...
            Case DataControlRowType.DataRow
                ...
                If (e.Row.Cells(24).Text <> "") Then
                    ...
                    If (e.Row.Cells(24).Text = "1") Then
                        e.Row.Cells(24).Text = Mid(ckl_rtype2.Items(0).Text, 3, 2)
                    End If


                    If (e.Row.Cells(24).Text = "2") Then
                        e.Row.Cells(24).Text = Mid(ckl_rtype2.Items(1).Text, 3, 3)

                    End If

                    If (e.Row.Cells(24).Text = "3") Then
                        e.Row.Cells(24).Text = Mid(ckl_rtype2.Items(2).Text, 3, 5)
