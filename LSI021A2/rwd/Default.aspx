...
<body>
    <form id="form1" runat="server">
        <table id="customers" style="position: relative; margin: 50px; width: 90%;" border="0" >
            <tr>
                <td width="100%">
                    <div>
                    ...
                    <div>
                        <asp:Panel ID="Panel_ExSearch" runat="server" HorizontalAlign="Left" Visible="False">
                            <table width="100%" border="1">
                                <tr>
                                    <td class="fail" colspan="2" style="text-align: center"><font color="blue">請輸入查詢條件：</font></td>
                                </tr>
                                <tr>
                                    <td class="style1">工程名稱</td>
                                    <td class="style2">
                                        <asp:TextBox ID="txt_com_name" runat="server" MaxLength="50" Width="100%"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1">工程地址</td>
                                    <td class="style2">
                                        <asp:DropDownList ID="ddl_att_area" runat="server">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                    <td class="style1">輕質屋頂作業</td>
                                    <td class="style2">
                        ...
                        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left" Visible="False">
                            <table width="100%" border="1">
                                <tr>
                                    <td class="export01" style="width: 14%; text-align: right"><font color="blue">請選擇匯出欄位：</font></td>
                                    <td class="export02">
                                        <asp:CheckBoxList ID="CBL_Field1" runat="server"
                                            RepeatDirection="Horizontal" RepeatColumns="6">
                                        </asp:CheckBoxList>
                                        &nbsp;<asp:CheckBox ID="ckb_all" runat="server" Text="全部欄位" />
                                    </td>
                                    <td class="export02" style="width: 5%;">
                                        <asp:Button ID="bt_excel" runat="server" Text="匯出Excel" PostBackUrl="Default.aspx" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
