...
Partial Class basic_LSI016A_Default
    Inherits PageBase
    ...
    Protected Sub setFields()
        ...
        news_title.HeaderStyle.CssClass = "grid1"
        news_type.HeaderStyle.CssClass = "grid1"
        ins_date.HeaderStyle.CssClass = "grid1"
        usr_code.HeaderStyle.CssClass = "grid1"

        '設定欄位的水平對齊
        news_code.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        news_title.ItemStyle.HorizontalAlign = HorizontalAlign.Left
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        If Not txtDataKey = "" Then
            ...
            If dt_tmp.Rows.Count > 0 Then
                Dim sMsg As String = "此新聞已被引用在下列電子報("
            ...
            Dim path1 As String = Get_SysPara("FileUpload") & txtDataKey & ".jpg"
