...
Partial Class basic_LSI025_Default
    Inherits PageBase
	...
	Dim tax_id As New BoundField()
Dim device_no As New BoundField()
Dim tower_path As New BoundField()
        ...
        pc_kind1_c.DataField = "tower_type"
      	pc_kind2_c.DataField = "tower_typ2"
	tax_id.DataField = "tax_id"
device_no.DataField = "device_no"

tower_path.DataField = "tower_path"
        ...
        pc_kind1_c.HeaderText = "定檢點"
	pc_kind2_c.HeaderText = "機械作業"
tax_id.HeaderText = "後5碼"
device_no.HeaderText = "鋼印號"
tower_path.HeaderText = "圖檔"
        '設定欄位是否自動換行(不換行的再設定)
...
tax_id.SortExpression = "tax_id"
device_no.SortExpression = "device_no"
tower_path.SortExpression = "tower_path"
        '欄位寬度(%):要留6%給編輯圖示
...
tax_id.ItemStyle.Width = Unit.Percentage(10)
device_no.ItemStyle.Width = Unit.Percentage(10)
tower_path.ItemStyle.Width = Unit.Percentage(10)
        '設定欄位標題顏色
	...
	tax_id.HeaderStyle.CssClass = "grid1"
device_no.HeaderStyle.CssClass = "grid1"
tower_path.HeaderStyle.CssClass = "grid1"
        '設定欄位的水平對齊
	...
	tax_id.ItemStyle.HorizontalAlign = HorizontalAlign.Left
	device_no.ItemStyle.HorizontalAlign = HorizontalAlign.Left
tower_path.ItemStyle.HorizontalAlign = HorizontalAlign.Left
	...
	GridView1.Columns.Add(tax_id)
	GridView1.Columns.Add(device_no)
GridView1.Columns.Add(tower_path)
End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            ...
            Set_CKL_Option("tower_type", "", ckl_pc_kind1, "", "", "B")
	    Set_CKL_Option("tower_typ2", "", ckl_pc_kind2, "", "", "B")
...
'Response.Write(SqlDS2.SelectCommand)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.Header Or e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(18).Visible = False '定檢
            e.Row.Cells(19).Visible = False '機械
...
if(Left(e.Row.Cells(22).text,1)="P") then
e.Row.Cells(22).text= "=hyperlink(""https://service2.lio.gov.taipei/LSIO_F/upload/File_tower/" & e.Row.Cells(22).text & """) "
end if
			...
			e.Row.Cells(5).Text = "建號"
                        ...
                        e.Row.Cells(18).Text = "定檢點"
			e.Row.Cells(19).Text = "機械作業"
			e.Row.Cells(20).Text = "ID後5碼"
			e.Row.Cells(21).Text = "鋼印號碼"
e.Row.Cells(22).Text = "圖檔"
        ...
        For i As Integer = 0 To ckl_pc_kind1.Items.Count - 1
            If ckl_pc_kind1.Items(i).Selected = True Then
                ...
                Else
                    txtSubWhere.Text &= " OR "
                End If
                txtSubWhere.Text &= "LSI025.tower_type1" & " LIKE N'%" & RepSql(ckl_pc_kind1.Items(i).Value) & "%'"
            End If
        Next
