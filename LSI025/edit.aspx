<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="basic_LSI025_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>
        <table cellpadding=5 cellspacing=0 width="100%" border="1" id="customers">
            ...
            <tr align="center"><td colspan="20" class="style1">塔式起重機事業單位回報</td></tr>
              ...
              <tr>
				...
				<tr>
                <td colspan="4" class="style1"><asp:Label ID="l_device_no" runat="server" Text="鋼印號：" /></td>
					<td colspan="8" class="style2"><asp:TextBox ID="txt_device_no" runat="server" maxlength="50" Width="200px" TabIndex="13" />
                    </td>
 <td colspan="4" class="style1"><asp:Label ID="l_tax_id" runat="server" Text="後5碼：" /></td>
					<td colspan="8" class="style2"><asp:TextBox ID="txt_tax_id" runat="server" maxlength="50" Width="200px" TabIndex="14" />
                    </td>
                </tr>
			  ...
			  <tr>
                <td colspan="4" class="style1"><asp:Label ID="l_pc_kind" runat="server" Text="<font color=red>*</font>定檢點：" /></td>
					<td colspan="8" class="style2" VALIGN="top">
					<asp:Label ID="l_pc_kind1" runat="server" Text="定檢點：" /><br>
					<asp:CheckBoxList ID="chk_pc_kind1" runat="server" TabIndex="21" 
                        RepeatColumns="1" RepeatDirection="Horizontal" />
                    </td>

					<td colspan="8" class="style2" VALIGN="top" >
					<asp:Label ID="l_pc_kind2" runat="server" Text="作業類別：" /><br>
