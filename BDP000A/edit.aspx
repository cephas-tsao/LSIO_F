<%@ Page Language="VB" AutoEventWireup="false" CodeFile="edit.aspx.vb" Inherits="management_BDP000A_edit" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <div>
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
                <td class="style1">
                    參數名稱<asp:Image ID="Image2" runat="server" ImageUrl="~/images/tick.png" /></td>
                <td class="style2">
                    <asp:TextBox ID="txt_par_name" runat="server" MaxLength="20" Width="100px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style1">
                    參數值</td>
                <td class="style2">
                    <asp:TextBox ID="txt_par_value" runat="server" MaxLength="150" Width="624px"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="style1">
                    備註</td>
                <td class="style2">
                    <asp:TextBox ID="txt_par_memo" runat="server" MaxLength="100" Width="624px"></asp:TextBox></td>
            </tr>              
        </table>
    </div>
