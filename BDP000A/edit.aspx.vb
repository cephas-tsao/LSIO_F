...
Partial Class management_BDP000A_edit
    Inherits PageBase
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If SaveEditData(s_prgcode, Pgm_Type, txtPrimary.Text, txt_par_name.Text, txt_par_value.Text, txt_par_memo.Text) Then
            '儲存使用紀錄
            ...
            If Pgm_Type <> "MDY" Then
                ...
                If txtSubWhere.Text <> "" Then
                    txtSubWhere.Text &= " OR bdp000='" & RepSql(sKeyPrimary) & "' "
                Else
                    txtSubWhere.Text = " WHERE bdp000='" & RepSql(sKeyPrimary) & "' "
                End If
            End If
            '存檔正確導回default頁面
            ...
            Select Case Pgm_type
                Case "MDY", "COPY"
                    ...
                    If Dt_tmp.Rows.Count > 0 Then
                        txt_par_name.Text = Trim(Dt_tmp.Rows(0).Item("par_name") & "")
                        txt_par_value.Text = Trim(Dt_tmp.Rows(0).Item("par_value") & "")
                        txt_par_memo.Text = Trim(Dt_tmp.Rows(0).Item("par_memo") & "")
                    End If

                    If Pgm_type = "COPY" Then
                        txt_par_name.Text = ""
                        txt_par_name.Enabled = True
                    Else
                        txt_par_name.Enabled = False
                    End If
            End Select
        End If
        l_ErrMsg.Text = ""
