<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FileUpload.aspx.vb" Inherits="basic_LSI009A_FileUpload" %>
  ...
  <table style="background-color:#EDEDED" border="1" Width="580px">
    ...
    <tr style="text-align:left;">
      <td>
        ...
        2.匯入檔案範本請"<a href="../../FileUpload/LSI009A_sample.xls">按此下載</a>"<br />
