...
Partial Class basic_LSI009A_Default
    Inherits PageBase
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        If Not txtDataKey = "" Then
            ...
            If dt_tmp.Rows.Count > 0 Then
                Dim sMsg As String = "此停工令已被引用在下列復工資料("
    ...
    Protected Sub bt_odf_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bt_odf.Click
        ...
        Response.Clear()
        Response.Write("<meta http-equiv=Content-Type content=text/html;charset=utf-8>")
        Response.AddHeader("content-disposition", "attachment;filename=Export.odf")
        Response.ContentType = "application/vnd.xls"
        Dim sw As System.IO.StringWriter = New System.IO.StringWriter()
        Dim htw As System.Web.UI.HtmlTextWriter = New HtmlTextWriter(sw)
