<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="management_BDP003B_Default" MaintainScrollPositionOnPostback="true" %>
...
//        }
    ...
    function Chk_Limit_Type() {
        if (window.confirm('權限變更完成！是否套用至全科室人員？') == true) {
...
<body>
    ...
    <div>
        選擇科室<asp:DropDownList ID="DDL1" runat="server">
        </asp:DropDownList>
