...
<table width="100%" border="1" id="customers" cellspacing='0.1'>
    ...
    <tr>
        <td class="style1-1">
            新聞編號</td>
        <td class="style2-1">
            <asp:TextBox ID="txt_news_code" runat="server" BackColor="#999999" 
                MaxLength="12" Width="100px"></asp:TextBox>
            <asp:ImageButton ID="IB_per_code" runat="server" CausesValidation="False" 
                ImageUrl="~/images/bs_search.gif" />
            <asp:TextBox ID="txt_news_title" runat="server" BackColor="#999999" 
                Width="500px"></asp:TextBox>
            <asp:TextBox ID="txt_news_type" runat="server" BackColor="#999999"></asp:TextBox>
            <asp:Button ID="bt_news_contect" runat="server" Text="編輯本文" />
        </td>
    </tr>
    <tr>
        <td class="style1-1">
            <asp:Label ID="l_news_contect" runat="server" Text="本文區" Visible="False"></asp:Label></td>
        <td class="style2-1">
            <FTB:FreeTextBox ID="txt_news_contect" runat="server" 
                Height="200px" Width="100%" Language="zh-TW" BreakMode="LineBreak" 
                Visible="False">
            </FTB:FreeTextBox></td>
    </tr>
    <tr>
        <td class="style1-1">
            顯示序號<asp:Image ID="Image4" runat="server" ImageUrl="~/images/tick.ico" />
        </td>
        <td class="style2-1">
    ...
    <asp:TextBox ID="txt_paper_code" runat="server" BackColor="#999999" 
