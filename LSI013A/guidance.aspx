<%@ Page Language="VB" AutoEventWireup="false" CodeFile="guidance.aspx.vb" Inherits="basic_LSI013A_guidance" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
        ...
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
                <td class="style1">
                    勞安宣導事項</td>
                <td class="style2">
                    <asp:TextBox ID="txt_content" runat="server" Width="525px" Height="500px" 
