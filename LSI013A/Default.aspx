<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="basic_LSI013A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
        ...
        <table width="100%" border ="1">
            <tr class="style8">
                <td style="width: 40%" colspan="2">
                    ...
                    通報種類：<asp:CheckBoxList ID="ckl_fix_type" runat="server" RepeatColumns="5" 
                        Height="16px">
                    </asp:CheckBoxList><asp:CheckBox ID="chkEng" runat="server" TabIndex="30"/>建築工程之外牆施工架拆組<asp:CheckBox ID="chktoher" runat="server" TabIndex="32"/>其他
