...
Partial Class basic_LSI013A_guidance
    Inherits PageBase
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If SaveEditData(s_prgcode, "guidance1", txt_content.Text) Then


            '儲存使用紀錄
            ws.InsUsrRec(PrgMemo, "guidance1", s_prgcode, Session("usr_code"), Session("usr_ip"), sFieldName, sOldData, sNewData)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim Dt_tmp As DataTable = Get_DataSet("guidance1", "").Tables(0)
