...
Partial Class management_BDP140A_Default
    Inherits PageBase
    ...
    Protected Sub setFields()
        ...
        Dim field_type As New BoundField()

        '指定資料來源欄位
        bdp140.DataField = "bdp140"
        ...
        '設定欄位標頭名稱
        bdp140.HeaderText = "識別碼"
        scr_no.HeaderText = "顯示序號"
        prg_code.HeaderText = "程式編號"
        field_code.HeaderText = "欄位編號"
        field_name.HeaderText = "欄位名稱"
        field_type.HeaderText = "欄位類別"

        '設定欄位是否自動換行(不換行的再設定)
        'prg_code.ItemStyle.Wrap = False

        '設定排序所對應的欄位
        'bdp140.SortExpression = "bdp140"
        ...
        field_type.SortExpression = "field_type"

        '設定欄位標題顏色
        bdp140.HeaderStyle.CssClass = "grid1"
        ...
        field_type.HeaderStyle.CssClass = "grid1"

        '設定欄位的水平對齊
        bdp140.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        ...
        field_type.ItemStyle.HorizontalAlign = HorizontalAlign.Center

        '設定欄位是否顯示(不顯示的再設定)
        bdp140.Visible = False

        'GridView1.Columns.Add(bdp140)
        ...
        GridView1.Columns.Add(field_type)
    End Sub
