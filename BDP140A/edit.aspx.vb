...
Partial Class management_BDP140A_edit
    Inherits PageBase

    Dim ws As New WebReference.LSIO_WebService
    Dim s_prgcode As String = "BDP140A"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If SaveEditData(s_prgcode, Pgm_Type, txtPrimary.Text, ddl_scr_no.SelectedValue, txt_prg_code.Text, txt_field_code.Text, txt_field_name.Text, ddl_field_type.SelectedValue) Then
            '儲存使用紀錄
            ...
            If Pgm_Type <> "MDY" Then
                ...
                If txtSubWhere.Text <> "" Then
                    txtSubWhere.Text &= " OR bdp140='" & RepSql(sKeyPrimary) & "' "
                Else
                    txtSubWhere.Text = " WHERE bdp140='" & RepSql(sKeyPrimary) & "' "
                End If
            End If
            '存檔正確導回default頁面
    ...
    Protected Function Chk_data() As Boolean
        ...
        '檢查必填欄位是否空白
        If txt_prg_code.Text = "" Or txt_field_code.Text = "" Or txt_field_name.Text = "" Then
            Chk_data = False
            ...
            Select Case Pgm_type
                Case "MDY", "COPY"
                    ...
                    If Dt_tmp.Rows.Count > 0 Then
                        ...
                        txt_prg_name.Text = ws.QueryData(txt_prg_code.Text, "BDP030", "prg_code", "prg_name")
                        txt_field_code.Text = Trim(Dt_tmp.Rows(0).Item("field_code") & "")
                        txt_field_name.Text = Trim(Dt_tmp.Rows(0).Item("field_name") & "")
                        ddl_scr_no.SelectedValue = Trim(Dt_tmp.Rows(0).Item("scr_no") & "")
                        ddl_field_type.SelectedValue = Trim(Dt_tmp.Rows(0).Item("field_type") & "")
                    End If
            End Select
        End If
        b_prg_code.Attributes("onclick") = ws.Set_AddForm("../../public/addform.aspx", "PRG-1", "1|2", "txt_prg_code|txt_prg_name", "")
        l_ErrMsg.Text = ""
    End Sub
    ...
    Protected Sub txt_prg_code_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_prg_code.TextChanged
        txt_prg_name.Text = ws.QueryData(txt_prg_code.Text, "BDP030", "prg_code", "prg_name")
    End Sub
End Class
