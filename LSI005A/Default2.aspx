<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default2.aspx.vb" Inherits="basic_LSI005A_Default2" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
...
<body >
    <form id="form1" runat="server">
     <table style="position:relative; margin-left:auto; margin-right:auto; width:720px;"  border ="0">
       ...
       <tr>
            ...
            <tr class="style8">
                <td style="width: 65%">
                    ...
                    <asp:Button ID="Button1" runat="server" ToolTip="查詢" Text="查詢" 
                        PostBackUrl="~/basic/LSI005A/Default2.aspx" />
                    <asp:Button ID="Button2" runat="server" Text="存檔取回" 
                        PostBackUrl="~/basic/LSI005A/Default2.aspx" />
                </td>
                <td style="text-align:center"><asp:ImageButton ID="Bt_subMenu" runat="server" CommandArgument="subMenu" 
                        ImageUrl="~/images/icon/search_ad.png" ToolTip="進階查詢" 
                        PostBackUrl="~/basic/LSI005A/Default2.aspx" />
                </td>
        ...
        <asp:SqlDataSource ID="SqlDS1" runat="server" />
            電子報排程編號﹕<asp:TextBox ID="txt_sch_code" runat="server" ReadOnly></asp:TextBox>
