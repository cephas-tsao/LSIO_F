...
Partial Class management_BDP002A_Default
    Inherits PageBase

    Dim s_prgcode As String = "BDP002A"
    ...
    Protected Sub Save_User_Data(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim dt_tmp As DataTable = Get_DataSet(s_prgcode, "GetMenu").Tables(0)
