...
Partial Class management_BDP030A_Default
    Inherits PageBase
    ...
    Protected Sub setFields()
        ...
        Dim s_date As New BoundField()
        Dim e_date As New BoundField()
        ...
        s_date.DataField = "s_date"
        e_date.DataField = "e_date"
        ...
        s_date.HeaderText = "啟用開始日期"
        e_date.HeaderText = "啟用結束日期"
        ...
        prg_type.SortExpression = "prg_type"
        is_use.SortExpression = "is_use"
        s_date.SortExpression = "s_date"
        e_date.SortExpression = "e_date"

        '欄位寬度(%):要留6%給編輯圖示
        prg_code.ItemStyle.Width = Unit.Percentage(20)
        prg_name.ItemStyle.Width = Unit.Percentage(30)
        prg_type.ItemStyle.Width = Unit.Percentage(10)
        is_use.ItemStyle.Width = Unit.Percentage(10)
        s_date.ItemStyle.Width = Unit.Percentage(10)
        e_date.ItemStyle.Width = Unit.Percentage(10)

        '設定標題顏色
        prg_code.HeaderStyle.CssClass = "grid1"
        prg_name.HeaderStyle.CssClass = "grid1"
        prg_type.HeaderStyle.CssClass = "grid1"
        is_use.HeaderStyle.CssClass = "grid1"
        s_date.HeaderStyle.CssClass = "grid1"
        e_date.HeaderStyle.CssClass = "grid1"
        ...
        s_date.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        e_date.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        ...
        GridView1.Columns.Add(s_date)
        GridView1.Columns.Add(e_date)
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            ...
            '設定Row的鍵值組成，具有唯一性
            Dim KeyNames() As String = {"prg_code"}
