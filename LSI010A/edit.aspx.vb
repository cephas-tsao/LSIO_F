...
txt_start_number.Text = Trim(Dt_tmp.Rows(0).Item("start_number") & "")	
txt_start_date.Text = Trim(Dt_tmp.Rows(0).Item("start_date") & "")
txt_eng_code.Text = Trim(Dt_tmp.Rows(0).Item("eng_code") & "")

		txt_stop_number.Text = Trim(Dt_tmp.Rows(0).Item("stop_number") & "")
                        txt_att_tel1.Text = Trim(Dt_tmp.Rows(0).Item("Att_tel1") & "")
			txt_att_email.Text = Trim(Dt_tmp.Rows(0).Item("Att_email") & "")
                       ...
                       ' Dim imgRoot = "/FileUpload/File_Reback/" & Trim(Dt_tmp.Rows(0).Item("start_code"))


			Dim imgRoot1 = "/FileUpload/File_Reback/" & Trim(Dt_tmp.Rows(0).Item("start_path2"))

			
			Dim imgRoot2 = "/FileUpload/File_Reback/" & Trim(Dt_tmp.Rows(0).Item("start_path1"))
			
			Dim imgRoot_1=right(imgRoot1,3)
			Dim imgRoot_2=right(imgRoot2,3)

			

						
	'If Not File.Exists(pdfRoot & "_1.pdf ") Then
						  ' Objec標籤
           ' Dim strCLSID As String =  "clsid:CA8A9780-280D-11CF-A24D-444553540000" 'pdf clsid
         ' Dim fileName As String = imgRoot & "_1.pdf"  'pdf檔案位置  
 
	'Dim fileName As String = pdfRoot   'pdf檔案位置  
			...
			'Dim pdfOcx As String =  "<OBJECT id=""pdf1"" height=""1024""  width=""700""  "  
				...
				'pdfOcx += " </OBJECT>"
                       ...
                       ' If  (pdf<>"jpg") Then
                             'Me.Literal1.Text = "<a href="+pdfRoot+">下載</a>"
			  'else 
	...
	'end if 
		  ...
		  If  (imgRoot_1="pdf") Then
                             Me.Literal1.Text = "<a href="+imgRoot1+">下載</a>"
			  else 
			    Me.Literal1.Text=""
	           end if 

		If  (imgRoot_2="pdf") Then
                             Me.Literal1.Text = Me.Literal1.Text+"<a href="+imgRoot2+">下載</a>"
			  else 
			    Me.Literal1.Text="沒有資料。"
	           end if
                        ...
                        if  (imgRoot_1="jpg" or imgRoot_1="JPG" or imgRoot_1="png" or imgRoot_1="PNG") Then
                          img_att1.ImageUrl = imgRoot1
                          img_att1.Width = 700
                        Else
                            img_att1.ImageUrl = ""
                            img_att1.Width = 300
			...
			if  (imgRoot_2="jpg" or imgRoot_2="JPG" or imgRoot_2="png" or imgRoot_2="PNG") Then
                          img_att2.ImageUrl = imgRoot2
                          img_att2.Width = 700
                        Else
                            img_att2.ImageUrl = ""
                            img_att2.Width = 300
