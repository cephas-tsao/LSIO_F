<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="basic_LSI010A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
     ...
     <tr>
        ...
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left" Visible="False">
            ...
            <td class="export02" style="width: 5%;"><asp:Button ID="bt_excel" runat="server" Text="匯出Excel" PostBackUrl="Default.aspx" /><br>
				<asp:Button ID="bt_odf" runat="server" Text="匯出ODF" PostBackUrl="Default.aspx" />
            </td></tr></table>
        </asp:Panel>       
