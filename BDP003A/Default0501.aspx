<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="management_BDP003A_Default" MaintainScrollPositionOnPostback="true" %>
...
//        }
    ...
    function Chk_Limit_Type() {
        if (window.confirm('權限變更完成！是否更改權限設定為帳號？') == true) {
            window.document.getElementById('Button_Hidden').click();
        }
    }
     </script>
</head>
<body>
    ...
    <div>
        選擇使用者<asp:DropDownList ID="DDL1" runat="server">
        </asp:DropDownList>
    ...
    <asp:Button ID="Button_Hidden" runat="server" Text="" style="display:none" />
    </form>
</body>
</html>
