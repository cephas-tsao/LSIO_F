<%@ Control Language="VB" AutoEventWireup="false" CodeFile="detail_edit.ascx.vb" Inherits="basic_OTB010A_detail_edit" %>
<table border ="0">
    <tr>
...
<table width="100%" border="1" id="customers" cellspacing='0.1'>
    <tr>
        ...
        <td class="style2-1" style="width: 100%">
            <asp:TextBox ID="txt_bdp190" runat="server" MaxLength="6" Width="100px" 
                Enabled="False" BackColor="#999999"></asp:TextBox></td>
    </tr>
            <tr>
                <td class="style1-1">
                                        回應者</td>
                <td class="style2-1" style="width: 35%">
            ...
            <tr>
                <td class="style1-1">
                                        <span id="l_bull_con">回應內容</span></td>
                <td class="style2-1" style="width: 35%">
    ...
    <asp:TextBox ID="txt_tn_code" runat="server" BackColor="#999999" Width="100px" 
        Visible="False" />
</asp:Panel>
</td>
</tr>
