...
pc_kind2_c.DataField = "pc_kind2_c"
pc_file.DataField = "pc_file_path"

        '設定欄位標頭名稱
        pc_code.HeaderText = "資料編號"
		eng_name.HeaderText = "名稱"
        eng_code.HeaderText = "建號"
        area_name.HeaderText = "地址-區"
        road_name.HeaderText = "地址-路段"
        eng_add.HeaderText = "地址"
...
'pc_file.SortExpression = "pc_file"
...
pc_file.ItemStyle.Width = Unit.Percentage(10)
...
pc_file.HeaderStyle.CssClass = "grid1"
...
pc_file.ItemStyle.HorizontalAlign = HorizontalAlign.Left
 ...
 e.Row.Cells(4).Visible = False
            ...
            If bPrint = True Then
                ...
                If ckb_all.Checked Then
                    ...
                    If e.Row.RowType = DataControlRowType.Header Then
                        ...
                        e.Row.Cells(4).Text = "名稱"
			e.Row.Cells(5).Text = "建號"
                        e.Row.Cells(6).Text = "地址-區"
                        e.Row.Cells(7).Text = "地址-路段"
                        e.Row.Cells(8).Text = "地址"
        ...
        Select Case e.Row.RowType
            ...
            Case DataControlRowType.DataRow
                ...
                Dim nSpilt1 = Split(Trim(HttpUtility.HtmlEncode(e.Row.Cells(18).Text) & ""), "|")
                Dim nSpilt2 = Split(Trim(HttpUtility.HtmlEncode(e.Row.Cells(19).Text) & ""), "|")
                If  bPrint  =  True  Then
