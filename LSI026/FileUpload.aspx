<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FileUpload.aspx.vb" Inherits="basic_LSI026_FileUpload" %>
  ...
  <table style="background-color:#EDEDED" border="1" Width="580px">
    <tr style="text-align:center;background-color:#4F94CD">
      ...
      <tr style="text-align:left;">
           <td>請選擇單位：
           <asp:DropDownlist id="unit" style="width:150px" runat="server">              
                <asp:listitem value="0" selected="selected">請選擇</asp:listitem>
            <asp:listitem value="1">一般科</asp:listitem>
            <asp:listitem value="2">勞條科</asp:listitem>
            </asp:DropDownlist>
    ...
    <tr style="text-align:left;">
      <td>
        ...
        2.匯入檔案範本請"<a href="../../upload/uploadLSI026_company.xls">按此下載</a>"<br />
