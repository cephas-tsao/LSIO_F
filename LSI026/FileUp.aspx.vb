...
Partial Class basic_LSI026_FileUp
    Inherits PageBase
    ...
    Protected Function Update_ExcelFile() As Boolean
        ...
        Try
            For Each row As DataRow In dsTmp.Tables(0).Rows
                ...
                usr_name = row.Item("檢查員").ToString.Trim
                'usr_mail = row.Item("連絡mail").ToString.Trim
                If usr_code = "" And usr_name = "" And usr_com = "" Then Continue For
                '計算總筆數
                iTotalCount += 1

                If Chk_RelData("Self_com", "", MrdCode.Text, usr_com, usr_name) = True Then
                    If SaveEditData("Self_com", "ADD", "", MrdCode.Text, usr_com, usr_name) = False Then
                        iFailCount += 1
