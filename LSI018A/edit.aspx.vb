...
Partial Class management_BDP220A_edit
    ...
    Dim s_prgcode As String = "BDP220A"
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If SaveEditData(s_prgcode, Pgm_Type, txtPrimary.Text, txt_prg_code.Text, txt_field_code.Text, txt_field_name.Text, txt_data_source.Text, _
                        ddl_data_type.SelectedValue, txt_scr_no.Text, ddl_is_use.SelectedValue) Then
            '儲存使用紀錄
            ...
            If Pgm_Type <> "MDY" Then
                ...
                If txtSubWhere.Text <> "" Then
                    txtSubWhere.Text &= " OR bdp220='" & RepSql(sKeyPrimary) & "' "
                Else
                    txtSubWhere.Text = " WHERE bdp220='" & RepSql(sKeyPrimary) & "' "
                End If
            End If
            '存檔正確導回default頁面
