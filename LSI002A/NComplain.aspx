<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NComplain.aspx.vb" Inherits="basic_LSI002A_NComplain" aspcompat="true" MaintainScrollPositionOnPostback="true" %>
        ...
        <table width="100%" border="1" id="customers" cellspacing='0.1'>
            ...
            <tr>
                <td class="style1">
                    未具名申訴注意事項</td>
                <td class="style2">
                    <asp:TextBox ID="txt_content" runat="server" Width="650px" Height="500px" 
