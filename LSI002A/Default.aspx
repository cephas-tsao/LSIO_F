<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="basic_LSI002A_Default" MaintainScrollPositionOnPostback="true" EnableEventValidation = "false" %>
        ...
        <table width="100%" border ="1">
            <tr class="style8">
                ...
                <td style="text-align:center">
                    <asp:ImageButton ID="ImageButton1" runat="server" CommandArgument="ADD" PostBackUrl="YComplain.aspx" 
                        ImageUrl="~/images/icon/post.png" ToolTip="具名注意事項" /> 
                    　<asp:ImageButton ID="ImageButton5" runat="server" CommandArgument="ADD" PostBackUrl="NComplain.aspx" 
                        ImageUrl="~/images/icon/post.png" ToolTip="未具名注意事項" />   
                    ...
                    　<!--<asp:ImageButton ID="IB_delete" runat="server" 
                        ImageUrl="~/images/icon/del2.png" ToolTip="刪除個資限制資料" PostBackUrl="Default.aspx"
