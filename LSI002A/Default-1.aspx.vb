...
Partial Class basic_LSI002A_Default
    ...
    Protected Sub setFields()
        ...
        Dim cmp_type As New BoundField()
        ...
        cmp_type.DataField = "cmp_types"

        '設定欄位標頭名稱
        cmp_code.HeaderText = "資料編號"
        usr_code.HeaderText = "建立者編號"
        cmp_name.HeaderText = "姓名"
        cmp_email.HeaderText = "電子信箱"
        cmp_type.HeaderText = "申訴類別"
        ...
        cmp_type.SortExpression = "cmp_types"
        ...
        cmp_type.ItemStyle.Width = Unit.Percentage(30)
        ...
        cmp_type.HeaderStyle.CssClass = "grid1"
        ...
        cmp_type.ItemStyle.HorizontalAlign = HorizontalAlign.Center
        ...
        GridView1.Columns.Add(cmp_type)
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            ...
            txtOrder.Text = " ORDER BY cmp_code DESC"
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        Select Case e.Row.RowType
            ...
            Case DataControlRowType.DataRow
                If Chk_Email(e.Row.Cells(6).Text) = False Then e.Row.Cells(6).Text &= "[無效信箱]"
